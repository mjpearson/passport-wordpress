...
function Strategy(options, verify) {
  options = options || {}; 
  options.authorizationURL = options.authorizationURL || 'https://wordpress.com/oauth/authorize';
  options.tokenURL = options.tokenURL || 'https://wordpress.com/oauth/token';
  this.profileUrl = options.profileUrl || "https://api.wordpress.com/user/status";
